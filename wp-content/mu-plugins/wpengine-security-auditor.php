...
class WPEngineSecurityAuditor_Events {
	...
	public function __construct() {
		$this->events = [
			...
			'update_site_option'        => [ 'option', 'old_value', 'value', 'network_id' ],
			'add_site_option'           => [ 'option', 'value', 'network_id' ],
			'delete_site_option'        => [ 'option', 'network_id' ],
		];
	...
	/**
	 * Log on update_site_option hook
	 *
	 * @param string $option Name of the network option
	 * @param mixed  $old_value Previous value of the network option
	 * @param mixed  $value Value of the network option
	 * @param int    $network_id ID of the network
	 *
	 * @see https://developer.wordpress.org/reference/hooks/update_site_option/
	 */
	public function on_update_site_option( $option, $old_value, $value, $network_id ) {
		if ( ! $this->is_tracked_option( $option ) ) {
			return;
		}
	...
	/**
	 * Log on add_site_option hook
	 *
	 * @param string $option Name of the network option
	 * @param mixed  $value Value of the network option
	 * @param int    $network_id ID of the network
	 *
	 * @see https://developer.wordpress.org/reference/hooks/add_site_option/
	 */
	public function on_add_site_option( $option, $value, $network_id ) {
		if ( ! $this->is_tracked_option( $option ) ) {
			return;
		}
	...
	/**
	 * Log on delete_site_option hook
	 *
	 * @param string $option Name of the network option
	 * @param int    $network_id ID of the network
	 *
	 * @see https://developer.wordpress.org/reference/hooks/delete_site_option/
	 */
	public function on_delete_site_option( $option, $network_id ) {
		if ( ! $this->is_tracked_option( $option ) ) {
			return;
		}
